...
function initializeFtcBlocks(FTCDiv, FTCParent, FTCArea, callback) {
  //setUpWebSocket();
  ...
  fetchJavaScriptForHardware(function(jsHardware, errorMessage) {
    if (jsHardware) {
      ...
      workspace = initializeBlockly(FTCDiv, FTCParent, FTCArea);
      initializeToolbox();
...
function initializeBlockly(FTCDiv, FTCParent, FTCArea) {
  ...
  parentArea = FTCParent; //document.getElementById('parentArea');
  //blocksAndBannerArea = document.getElementById('blocksAndBannerArea');
  blocklyArea = FTCArea; //document.getElementById('blocklyArea');
  blocklyDiv = FTCDiv; //document.getElementById('blocklyDiv');
